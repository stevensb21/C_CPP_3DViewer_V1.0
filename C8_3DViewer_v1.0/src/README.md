...
2. [Установка. Команды Makefile](#установка-команды-makefile)
3. [Техническое задание](#техническое-задание)

## Обзор приложения

![3DViewer](../misc/images/record.gif)

## Установка. Команды Makefile

Перед установкой убедитесь, что установлены следующие компоненты: компилятор `gcc`, утилиты `make` и `qmake`
...
* **run**: Запуск приложения из папки build

* **dvi**: Просмотр документации по проекту

* **dist**: Создание дистрибутива с расширением `.tgz`

* **test**: Запуск тестирования модулей приложения

* **gcov_report**: Генерация html-отчета с информацией покрытия всех функций тестами

* **s21_3dviewer.a**: Создание статической библиотеки

* **leaks**: Проверка проекта на утечки памяти

* **style**: Проверка кода на соответствение требованиям стиля Google
